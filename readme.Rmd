...
**Ben Hicks** $\rightarrow$ [twitter](https://twitter.com/benimbenix), [blog](https://koanmathematics.wordpress.com/)
...
**Joshua Weidlich** $\rightarrow$ [twitter](@hassenrueb), [blog](https://joshuaweidlich.wordpress.com/)
